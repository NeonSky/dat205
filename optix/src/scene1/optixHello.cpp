/*
 * optixHello.cpp -- Renders a solid color image.
 *
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        const char *ptx = sutil::getPtxString( "scene1", "draw_color.cu" );
        ...
        RT_CHECK_ERROR( rtVariableSet3f( draw_color, 0.762f, 0.225f, 0.0f ) );
